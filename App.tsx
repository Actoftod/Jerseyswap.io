...
// Optimized: Defined outside component to prevent recreation on every render
const sports = [
...
const App: React.FC = () => {
  ...
  // Optimized: Lazy initialization to avoid creating new GeminiService on every render
